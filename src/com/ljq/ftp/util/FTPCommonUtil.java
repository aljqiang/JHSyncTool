...
public class FTPCommonUtil {
    ...
    public FTPCommonUtil(String server, int port, String uname, String password) {
        this.server = server;
        if (this.port > 0) {
            this.port = port;
        }
...
//            throw new Exception("本地路径不存在,请检查!");
    ...
    public static void setParameter() {
        ...
        try {
            InputStream in = FTPCommonUtil.class.getClassLoader().getResourceAsStream("ftp.properties");
            properties.load(in);
        ...
        timer.schedule(new TimerTask() {
            public void run() {
                ...
                try {
                    ...
                    // 获取FTP连接
                    FTPCommonUtil fu = new FTPCommonUtil(ip, Integer.valueOf(port), uname, password);
